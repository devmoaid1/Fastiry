  ...
  Widget build(BuildContext context) {
      ...
      _entryList.add(PopupMenuItem(
          ...
          onTap: () async {
            if (await canLaunchUrl(
                Uri.parse('${AppConstants.BASE_URL}/deliveryman/apply'))) {
              launchUrl(
                  Uri.parse('${AppConstants.BASE_URL}/deliveryman/apply'));
            }
          }));
    ...
    if (Get.find<SplashController>().configModel.toggleRestaurantRegistration) {
      _entryList.add(PopupMenuItem(
          ...
          onTap: () async {
            if (await canLaunchUrl(
                Uri.parse('${AppConstants.BASE_URL}/restaurant/apply'))) {
              launchUrl(Uri.parse('${AppConstants.BASE_URL}/restaurant/apply'));
            }
          }));
    }
