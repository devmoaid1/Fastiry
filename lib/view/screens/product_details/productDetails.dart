                                          ...
                                          Container(
                                            ...
                                            child: Row(children: [
                                              QuantityButton(
                                                ...
                                                isIncrement: false,
                                                canDecrement: productController
                                                        .quantity !=
                                                    1,
                                              ),
                                              Text(
                              ...
                              return Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                          'Select ${widget.product.choiceOptions[index].title}',
                                          style: poppinsMedium.copyWith(
                                              fontSize: Dimensions
                                                      .blockscreenHorizontal *
                                                  4)),
                                      ...
                                      child: GridView.builder(
                                        ...
                                        itemBuilder: (context, i) {
                                          return InkWell(
                                            onTap: () {
                                              print(
                                                  '---check for update  ${widget.cartItem != null ? widget.cartItem.toJson() : null} and ${productController.cartIndex}-----');
                                              print(
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    '(${PriceConverter.convertPrice(((widget.product.variations[i].price) - (widget.product.price)))}+)',
                                                    maxLines: 1,
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style:
