...
class RestaurantController extends GetxController implements GetxService {
  ...
  void initRestaurantPage(Restaurant restaurant) {
    // setIsLoading(true);

    getRestaurantDetails(
        Restaurant(id: restaurant.id)); // get restaurant Details
    ...
    getRestaurantProductList(restaurant.id, 1, 'all', false);
  }
  ...
  Future<Restaurant> getRestaurantDetails(Restaurant restaurant) async {
    ...
    if (restaurant.name != null) {
      ...
      if (response.statusCode == 200) {
        ...
        _isAvailable =
            isRestaurantOpenNow(_restaurant.active, _restaurant.schedules);
